...
import com.manoj.service.CustomerUserServiceImplementation;
...
public class AuthController {
    ...
    private Authentication authenticate(String username, String password) {
        ...
        System.out.println("signing in userDetails - "+userDetails);
        ...
        {
            System.out.println("sign in userDetails - password not matched "+userDetails);
            throw new BadCredentialsException("Invalid user or password");
        }
